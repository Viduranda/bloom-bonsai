...
// Tier 1: Try Primary AlwaysData Database Config
try {
...
// Tier 2: Try AlwaysData Localhost Socket
if (!$connected) {
    try {
        $pdo = new PDO("mysql:host=localhost;dbname=bloom-bonsai_db;charset=utf8mb4", "bloom-bonsai", "12345slA@#", [
            PDO::ATTR_ERRMODE            => PDO::ERRMODE_EXCEPTION,
            PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC,
            PDO::ATTR_EMULATE_PREPARES   => false,
        ]);
